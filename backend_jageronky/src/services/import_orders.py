...
class ImportService:
    ...
    async def import_orders(
        ...
        state_rate = Decimal(str(Config.TAX_DATA["consts"]["state_rate"]))
        mctd_rate = Decimal(str(Config.TAX_DATA["consts"]["mctd_rate"]))
        mctd_counties = set(Config.TAX_DATA["mctd_counties"])
